...
namespace Microsoft.Xna.Framework.Audio
{
    ...
    internal class XACTSound
    {
        ...
        public XACTSound(ushort track, byte waveBank)
        {
            ...
            INTERNAL_clips[0] = new XACTClip(track, waveBank, 0);
            Category = 0;
            Volume = 0.0;
        ...
        public XACTSound(BinaryReader reader)
        {
            ...
            if (complex)
            {
                for (int i = 0; i < INTERNAL_clips.Length; i += 1)
                {
                    ...
                    // Parse the Clip.
                    INTERNAL_clips[i] = new XACTClip(reader, clipVolume, filterType, (short)i);

                    // Back to where we were...
                    reader.BaseStream.Seek(curPos, SeekOrigin.Begin);
                }

                if (RPCCodes.Count > 1 && RPCCodes.Count == INTERNAL_clips.Length)
                {
                    // only RPC codes for tracks exists. Add empty List for "Sound"
                    RPCCodes.Insert(0, new uint[0]);
                }
            }
    ...
    internal class XACTClip
    {
        ...
        public XACTClip(ushort track, byte waveBank, short trackIndex)
        {
        ...
        public XACTClip(BinaryReader reader, double clipVolume, byte filterType, short trackIndex)
        {
    ...
    internal class PlayWaveEvent : XACTEvent
    {
        ...
        internal readonly short INTERNAL_trackIndex;
        ...
        ) : base(1, timestamp)
        {
            ...
            INTERNAL_trackIndex = trackIndex;
